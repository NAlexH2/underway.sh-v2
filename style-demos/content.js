...
window.SITE = {
  ...
  // Each project's writeup is an array of blocks: {p:"html"} paragraph,
  // {sub:"text"} sub-heading, or {list:["html", ...]} bulleted list.
  projects: [
    {
      title: "underway.sh",
      dates: "July 2026",
      ...
      featured: true,
      stack: ["AWS Amplify (Hosting)", "Cloudflare (DNS)", "Vite", "React", "React Router", "TypeScript", "Tailwind CSS", "HTML", "AI coding agents"],
      writeup: [
